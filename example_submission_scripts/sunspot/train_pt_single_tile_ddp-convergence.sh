...
#####################################################################
OUTPUT_DIR=/lus/gila/projects/Aurora_deployment/cadams/ct_output-v2.1/
WORKDIR=/home/cadams/CosmicTagger-latest/
cd ${WORKDIR}
...
run_id=sunspot-yolo-single-tile-ddp-n${NRANKS}-df${DATA_FORMAT}-p${PRECISION}-4
